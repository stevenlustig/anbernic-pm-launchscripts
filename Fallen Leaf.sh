#!/bin/bash
#this will require openal.so.1 library, download it from the undertale one or copy it to libs
export HOME=/root
...
export LD_LIBRARY_PATH="/usr/lib:/usr/lib32:$GAMEDIR/libs:$TOOLDIR/libs:$LD_LIBRARY_PATH"
