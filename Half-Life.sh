...
export LD_LIBRARY_PATH="$GAMEDIR/libs.aarch64:$LD_LIBRARY_PATH:/usr/lib32:$GAMEDIR/valve/dlls:$GAMEDIR/valve/cl_dlls"

$GPTOKEYB "xash3d.aarch64" &
$TASKSET ./xash3d.aarch64 -ref gles2 -fullscreen -console $RUNMOD 2>&1 | tee -a ./log.txt
